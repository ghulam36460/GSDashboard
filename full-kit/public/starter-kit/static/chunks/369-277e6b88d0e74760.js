  ...
  [369],
  {
    378: (e, r, t) => {
      ...
      let o = (e) => {
        ...
        m = (e) => ({ cache: p(e.cacheSize), parseClassName: b(e), ...o(e) }),
        g = /\s+/,
        h = (e, r) => {
          let {
              parseClassName: t,
      ...
      let H = (function (e, ...r) {
        ...
        return {
          ...
          theme: {
            ...
            gradientColorStopPositions: [G, P],
            inset: S(),
            margin: S(),
            opacity: K(),
            padding: I(),
          ...
          classGroups: {
            ...
            grow: [{ grow: H() }],
            shrink: [{ shrink: H() }],
            order: [{ order: ["first", "last", "none", A, W] }],
            "grid-cols": [{ "grid-cols": [q] }],
            "col-start-end": [{ col: ["auto", { span: ["full", A, W] }, W] }],
            "col-start": [{ "col-start": B() }],
            "col-end": [{ "col-end": B() }],
            "grid-rows": [{ "grid-rows": [q] }],
            "row-start-end": [{ row: ["auto", { span: [A, W] }, W] }],
            ...
            "underline-offset": [{ "underline-offset": ["auto", O, W] }],
            ...
            "outline-offset": [{ "outline-offset": [O, W] }],
            ...
            contrast: [{ contrast: [i] }],
            "drop-shadow": [{ "drop-shadow": ["", "none", M, W] }],
    ...
    3343: (e, r, t) => {
      ...
      var o = t(2149),
        ...
        s = o.forwardRef((e, r) => {
          ...
          return (0, l.jsx)(a, { ...n, ref: r, children: t })
        })
      s.displayName = "Slot"
