...
export const coreBenefitsData: CoreBenefitType[] = [
  {
    ...
    description:
      "GSDashboard equips developers with the latest tools to rapidly build scalable, modern dashboards with less friction.",
    points: [
  ...
  },
  {
    ...
    description:
      "With customizable themes and built-in accessibility, GSDashboard adapts seamlessly to your team's needs and user diversity.",
    points: [
      "/UI and Radix UI components for a polished, accessible interface",
  ...
  },
  {
    ...
    description:
      "GSDashboard includes essential, production-ready features like authentication, form validation, and rich data components.",
    points: [
