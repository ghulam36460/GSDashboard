    ...
    <section className="container space-y-10">
      <div className="grid place-items-center text-center gap-y-4">
        ...
        <p className="max-w-prose w-full text-lg text-muted-foreground">
          A complete GSDashboard template with 4 apps, 20+ pages, and everything
          wired up using React 19, Next.js 15, and Tailwind CSS 4.
        </p>
...
function SocialProofBadge() {
  return (
    <a
      href="https://github.com/ghulam36460/GSDashboard"
      className={cn(
